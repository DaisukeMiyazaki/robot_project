...
void subDurationcallback( const std_msgs::UInt32& Duration_msg){
...
ros::Subscriber<std_msgs::Int32> subControl("Control", &subControlcallback);
ros::Subscriber<std_msgs::UInt32> subDuration("Duration", &subDurationcallback);
