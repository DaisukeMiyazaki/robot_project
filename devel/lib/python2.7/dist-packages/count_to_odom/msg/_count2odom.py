...
"""autogenerated by genpy from count_to_odom/count2odom.msg. Do not edit."""
import sys
...
class count2odom(genpy.Message):
  _md5sum = "04f23456ab3652e21764b7e147ee8492"
  _type = "count_to_odom/count2odom"
...
geometry_msgs/TwistWithCovariance twist
"""
  __slots__ = ['header','child_frame_id','pose','twist','odom']
  _slot_types = ['std_msgs/Header','string','geometry_msgs/PoseWithCovariance','geometry_msgs/TwistWithCovariance','nav_msgs/Odometry']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,child_frame_id,pose,twist,odom
    ...
    """
    if args or kwds:
      super(count2odom, self).__init__(*args, **kwds)
